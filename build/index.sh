...
download 'https://github.com/GyanD/codexffmpeg/releases/download/5.1.1/ffmpeg-5.1.1-essentials_build.7z' win32-x64.7z
echo '  extracting'
tmpdir=$(mktemp -d)
...
# download 'https://github.com/sudo-nautilus/FFmpeg-Builds-Win32/releases/download/todo/ffmpeg-n5.1.1-2-g915ef932a3-win32-gpl-5.1.1.zip' win32-ia32.zip
# echo '  extracting'
# unzip -o -d ../bin -j win32-ia32.zip '*/bin/ffmpeg.exe'
# mv ../bin/ffmpeg.exe ../bin/win32-ia32
# curl -sf -L 'https://raw.githubusercontent.com/sudo-nautilus/FFmpeg-Builds-Win32/todo/LICENSE' -o ../bin/win32-ia32.LICENSE

echo 'linux x64'
echo '  downloading from johnvansickle.com'
download 'https://johnvansickle.com/ffmpeg/releases/ffmpeg-5.1.1-amd64-static.tar.xz' linux-x64.tar.xz
echo '  extracting'
...
echo 'linux ia32'
echo '  downloading from johnvansickle.com'
download 'https://johnvansickle.com/ffmpeg/releases/ffmpeg-5.1.1-i686-static.tar.xz' linux-ia32.tar.xz
echo '  extracting'
...
echo 'linux arm'
echo '  downloading from johnvansickle.com'
download 'https://johnvansickle.com/ffmpeg/releases/ffmpeg-5.1.1-armhf-static.tar.xz' linux-arm.tar.xz
echo '  extracting'
...
echo 'linux arm64'
echo '  downloading from johnvansickle.com'
download 'https://johnvansickle.com/ffmpeg/releases/ffmpeg-5.1.1-arm64-static.tar.xz' linux-arm64.tar.xz
echo '  extracting'
...
download $(curl 'https://evermeet.cx/ffmpeg/info/ffmpeg/5.1.1' -sfL | jq -rc '.download.zip.url') darwin-x64.zip
echo '  extracting'
unzip -o -d ../bin -j darwin-x64.zip ffmpeg
mv ../bin/ffmpeg ../bin/darwin-x64
curl -sf -L 'https://git.ffmpeg.org/gitweb/ffmpeg.git/blob_plain/n5.1.1:/LICENSE.md'  -o ../bin/darwin-x64.LICENSE
curl -sf -L 'https://evermeet.cx/ffmpeg/info/ffmpeg/5.1.1' | jq --tab '.' >../bin/darwin-x64.README

echo 'darwin arm64'
echo '  downloading from osxexperts.net'
download 'https://www.osxexperts.net/FFmpeg511ARM.zip' darwin-arm64.zip
echo '  extracting'
unzip -o -d ../bin -j darwin-arm64.zip ffmpeg
mv ../bin/ffmpeg ../bin/darwin-arm64
curl -sf -L 'https://git.ffmpeg.org/gitweb/ffmpeg.git/blob_plain/n5.1.1:/LICENSE.md'  -o ../bin/darwin-arm64.LICENSE
curl -sf -L 'https://git.ffmpeg.org/gitweb/ffmpeg.git/blob_plain/n5.1.1:/README.md'  -o ../bin/darwin-arm64.README
...
curl -sf -L 'https://github.com/Thefrank/ffmpeg-static-freebsd/releases/download/v5.1.1/GPLv3.LICENSE' -o ../bin/freebsd-x64.LICENSE
curl -sf -L 'https://git.ffmpeg.org/gitweb/ffmpeg.git/blob_plain/n5.1.1:/README.md' -o ../bin/freebsd-x64.README
