...
echo '  compressing'
$tar_exec -C ../bin/win32/x64 -czvf ../bin/win32/x64/ffmpeg.tar.gz ffmpeg.exe
...
echo '  compressing'
$tar_exec -C ../bin/win32/ia32 -czvf ../bin/win32/ia32/ffmpeg.tar.gz ffmpeg.exe
...
echo '  compressing'
$tar_exec -C ../bin/linux/x64 -czvf ../bin/linux/x64/ffmpeg.tar.gz ffmpeg
...
echo '  compressing'
$tar_exec -C ../bin/linux/ia32 -czvf ../bin/linux/ia32/ffmpeg.tar.gz ffmpeg
...
echo '  compressing'
$tar_exec -C ../bin/linux/arm -czvf ../bin/linux/arm/ffmpeg.tar.gz ffmpeg
...
echo '  compressing'
$tar_exec -C ../bin/linux/arm64 -czvf ../bin/linux/arm64/ffmpeg.tar.gz ffmpeg
...
echo '  compressing'
$tar_exec -C ../bin/darwin/x64 -czvf ../bin/darwin/x64/ffmpeg.tar.gz ffmpeg